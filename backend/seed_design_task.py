"""
Insert a sample design / creative task + optional task_assignment for STUDENT_EMAIL.
Usage:
  python seed_design_task.py
...
TASK_DOC = {
    'title': 'UI wireframe — login screen',
    'description': (
        'Upload a single image (PNG or JPEG) or PDF showing a low-fidelity wireframe '
        'for a login screen. Mentor will review alignment with the brief (FR5).'
    ),
    'domain': 'Design',
    'difficulty': 'beginner',
    'task_type': 'design',
...
def main():
    ...
    print(f'Inserted design task _id: {tid}')
    ...
    print('POST /api/submissions/design (multipart: assignment_id, file)')
